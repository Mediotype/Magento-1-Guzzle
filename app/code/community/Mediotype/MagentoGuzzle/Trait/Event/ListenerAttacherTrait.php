 ...
 * dependencies.
 */
trait Mediotype_MagentoGuzzle_Trait_Event_ListenerAttacherTrait
{
    /**
     * Attaches event listeners and properly sets their priorities and whether
     * or not they are are only executed once.
     *
     * @param Mediotype_MagentoGuzzle_Model_Event_HasEmitterInterface $object    Object that has the event emitter.
     * @param array               $listeners Array of hashes representing event
     *                                       event listeners. Each item contains
     *                                       "name", "fn", "priority", & "once".
     */
    private function attachListeners(Mediotype_MagentoGuzzle_Model_Event_HasEmitterInterface $object, array $listeners)
    {
