 ...
 */
class Mediotype_MagentoGuzzle_Model_Collection implements
    ArrayAccess,
    IteratorAggregate,
    Countable,
    Mediotype_MagentoGuzzle_Model_ToArrayInterface
{
    use Mediotype_MagentoGuzzle_Trait_HasDataTrait;
     ...
     *
     * @return Mediotype_MagentoGuzzle_Model_Collection Returns a reference to the object
     */
     ...
     *
     * @param Mediotype_MagentoGuzzle_Model_Collection|array $data Associative array of key value pair data
     *
     * @return Mediotype_MagentoGuzzle_Model_Collection Returns a reference to the object.
     */
    ...
    public function overwriteWith($data)
    {
        ...
        } elseif ($data instanceof Mediotype_MagentoGuzzle_Model_Collection) {
