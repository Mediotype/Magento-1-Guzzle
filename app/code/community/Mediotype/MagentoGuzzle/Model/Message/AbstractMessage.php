<?php
abstract class Mediotype_MagentoGuzzle_Model_Message_AbstractMessage implements Mediotype_MagentoGuzzle_Model_Message_MessageInterface
{
    ...
    /** @var Mediotype_MagentoGuzzle_Model_Streams_StreamInterface Message body */
    private $body;
    ...
    public function setBody(Mediotype_MagentoGuzzle_Model_Streams_StreamInterface $body = null)
    {
        if ($body === null) {
     ...
     *
     * @param Mediotype_MagentoGuzzle_Model_Message_MessageInterface $message That contains the header
     * @param string           $header  Header to retrieve from the message
     *
     * @return array Returns the parsed header values.
     */
    public static function parseHeader(Mediotype_MagentoGuzzle_Model_Message_MessageInterface $message, $header)
    {
        static $trimmed = "\"'  \n\t\r";
     ...
     */
    public static function normalizeHeader(Mediotype_MagentoGuzzle_Model_Message_MessageInterface $message, $header)
    {
     ...
     *
     * @param Mediotype_MagentoGuzzle_Model_Message_MessageInterface $message
     *
     * @return string
     */
    public static function getStartLineAndHeaders(Mediotype_MagentoGuzzle_Model_Message_MessageInterface $message)
    {
     ...
     * @return string
     */
    public static function getHeadersAsString(Mediotype_MagentoGuzzle_Model_Message_MessageInterface $message)
    {
        $result  = '';
     ...
     */
    public static function getStartLine(Mediotype_MagentoGuzzle_Model_Message_MessageInterface $message)
    {
        if ($message instanceof Mediotype_MagentoGuzzle_Model_Message_RequestInterface) {
            return trim($message->getMethod() . ' '
                . $message->getResource())
                . ' HTTP/' . $message->getProtocolVersion();
        } elseif ($message instanceof Mediotype_MagentoGuzzle_Model_Message_ResponseInterface) {
