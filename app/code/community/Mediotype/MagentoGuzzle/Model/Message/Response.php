 ...
 */
class Mediotype_MagentoGuzzle_Model_Message_Response extends Mediotype_MagentoGuzzle_Model_Message_AbstractMessage implements Mediotype_MagentoGuzzle_Model_Message_ResponseInterface
{
     ...
     * @param Mediotype_MagentoGuzzle_Model_Streams_StreamInterface $body       The body of the response
    ...
    public function __construct(
        $statusCode,
        array $headers = array(),
        Mediotype_MagentoGuzzle_Model_Streams_StreamInterface $body = null,
        array $options = array()
    ) {
    ...
    public function json(array $config = array())
    {
        ...
        try {
            ...
            throw new Mediotype_MagentoGuzzle_Model_Exception_ParseException(
                $e->getMessage(),
                $this
            );
        }
