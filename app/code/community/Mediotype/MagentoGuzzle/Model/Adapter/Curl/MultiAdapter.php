 ...
 */
class Mediotype_MagentoGuzzle_Model_Adapter_Curl_MultiAdapter implements Mediotype_MagentoGuzzle_Model_Adapter_AdapterInterface, Mediotype_MagentoGuzzle_Model_Adapter_ParallelAdapterInterface
{
     ...
     * @throws Mediotype_MagentoGuzzle_Model_Exception_AdapterException
     */
    public static function throwMultiError($code)
    {
        ...
        throw new Mediotype_MagentoGuzzle_Model_Exception_AdapterException(sprintf('cURL error %s: %s', $code, $buffer));
    }

    public function send(Mediotype_MagentoGuzzle_Model_Adapter_TransactionInterface $transaction)
    {
        $context = new Mediotype_MagentoGuzzle_Model_Adapter_Curl_BatchContext($this->checkoutMultiHandle(), true);
    ...
    {
        $context = new Mediotype_MagentoGuzzle_Model_Adapter_Curl_BatchContext(
    ...
    private function perform(Mediotype_MagentoGuzzle_Model_Adapter_Curl_BatchContext $context)
    {
    ...
    private function processMessages(Mediotype_MagentoGuzzle_Model_Adapter_Curl_BatchContext $context)
    {
        $multi = $context->getMultiHandle();
    ...
    private function processResponse(
        ...
        array $curl,
        Mediotype_MagentoGuzzle_Model_Adapter_Curl_BatchContext $context
    ) {
    ...
    private function isCurlException(
        ...
        try {
            ...
            Mediotype_MagentoGuzzle_Model_Event_RequestEvents::emitError(
                $transaction,
                new Mediotype_MagentoGuzzle_Model_Exception_RequestException(
                    sprintf(
                        '[curl] (#%s) %s [url] %s',
                        $curl['result'],
    ...
    private function throwException(Exception $e, Mediotype_MagentoGuzzle_Model_Adapter_Curl_BatchContext $context)
    {
        if ($context->throwsExceptions()
            || ($e instanceof Mediotype_MagentoGuzzle_Model_Exception_RequestException && $e->getThrowImmediately())
        ) {
            $context->removeAll();
     ...
     * @param Mediotype_MagentoGuzzle_Model_Adapter_Curl_BatchContext         $context
     *
