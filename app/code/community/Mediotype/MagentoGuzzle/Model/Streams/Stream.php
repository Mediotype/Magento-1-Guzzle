 ...
 */
class Mediotype_MagentoGuzzle_Model_Streams_Stream implements Mediotype_MagentoGuzzle_Model_Streams_MetadataStreamInterface
{
    private $stream;
    private $size;
    private $seekable;
     ...
     *
     * @param resource|string|Mediotype_MagentoGuzzle_Model_Streams_StreamInterface $resource Entity body data
     * @param int                             $size     Size of the data contained in the resource
     *
     * @return Mediotype_MagentoGuzzle_Model_Streams_Stream
    ...
    public static function factory($resource = '', $size = null)
    {
        ...
        if ($resource instanceof Mediotype_MagentoGuzzle_Model_Streams_StreamInterface) {
            return $resource;
        }
