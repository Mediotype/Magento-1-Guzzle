 ...
 */
class Mediotype_MagentoGuzzle_Model_Post_PostBody implements Mediotype_MagentoGuzzle_Model_Post_PostBodyInterface
{
    /** @var Mediotype_MagentoGuzzle_Model_Streams_StreamInterface */
    private $body;
    ...
    /** @var Mediotype_MagentoGuzzle_Model_Post_PostFileInterface[] */
    private $files = array();
     ...
     */
    public function applyRequestHeaders(Mediotype_MagentoGuzzle_Model_Message_RequestInterface $request)
    {
    ...
    public function getFields($asString = false)
    {
        ...
        return (string) (new Mediotype_MagentoGuzzle_Model_Query($this->fields))
            ->setEncodingType(Mediotype_MagentoGuzzle_Model_Query::RFC1738)
    ...
    public function addFile(Mediotype_MagentoGuzzle_Model_Post_PostFileInterface $file)
    {
        $this->files[] = $file;
        $this->mutate();
    ...
    private function getBody()
    {
        if ($this->body) {
            ...
            return $this->body = Mediotype_MagentoGuzzle_Model_Streams_Stream::factory();
        }
    }
    ...
    {
        if (!$this->aggregator) {
            $this->aggregator = Mediotype_MagentoGuzzle_Model_Query::phpAggregator();
        }
     ...
     *
     * @return Mediotype_MagentoGuzzle_Model_Post_MultipartBody
     */
    private function createMultipart()
    {
        // Flatten the nested query string values using the correct aggregator
        return new Mediotype_MagentoGuzzle_Model_Post_MultipartBody(
    ...
    {
        return Mediotype_MagentoGuzzle_Model_Streams_Stream::factory($this->getFields(true));
    }
