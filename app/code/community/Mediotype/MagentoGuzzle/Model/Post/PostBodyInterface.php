 ...
 */
interface Mediotype_MagentoGuzzle_Model_Post_PostBodyInterface extends Mediotype_MagentoGuzzle_Model_Streams_StreamInterface, Countable
{
    /**
     ...
     *
     * @return Mediotype_MagentoGuzzle_Model_Post_PostFileInterface|null
     */
     ...
     *
     * @param Mediotype_MagentoGuzzle_Model_Post_PostFileInterface $file File to add
     *
     * @return $this
     */
