 ...
 */
interface Mediotype_MagentoGuzzle_Model_ClientInterface extends Mediotype_MagentoGuzzle_Model_Event_HasEmitterInterface
{
    const VERSION = '4.2.1';

    /**
     * Create and return a new {@see Mediotype_MagentoGuzzle_Model_Message_RequestInterface} object.
     *
     ...
     * @param string|array|Mediotype_MagentoGuzzle_Model_Url $url     URL or URI template
     ...
     *
     * @return Mediotype_MagentoGuzzle_Model_Message_RequestInterface
     * @throws Mediotype_MagentoGuzzle_Model_Exception_RequestException When an error is encountered
     */
     ...
     *
     * @param Mediotype_MagentoGuzzle_Model_Message_RequestInterface $request Request to send
     *
     ...
     *
     * @throws Mediotype_MagentoGuzzle_Model_Exception_AdapterException When an error occurs in the HTTP adapter.
     */
