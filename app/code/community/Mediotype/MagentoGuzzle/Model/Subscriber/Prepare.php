 ...
 */
class Mediotype_MagentoGuzzle_Model_Subscriber_Prepare implements Mediotype_MagentoGuzzle_Model_Event_SubscriberInterface
{
    public function getEvents()
    {
        return array('before' => array('onBefore', Mediotype_MagentoGuzzle_Model_Event_RequestEvents::PREPARE_REQUEST));
    }
    ...
    public function onBefore(Mediotype_MagentoGuzzle_Model_Event_BeforeEvent $event)
    {
        ...
        if ($body instanceof Mediotype_MagentoGuzzle_Model_Post_PostBodyInterface) {
    ...
    private function addContentType(
        ...
        Mediotype_MagentoGuzzle_Model_Streams_StreamInterface $body
    ) {
        if (!($body instanceof Mediotype_MagentoGuzzle_Model_Streams_MetadataStreamInterface)) {
            return;
        }
        ...
        if ($contentType = Mediotype_MagentoGuzzle_Model_Mimetypes::getInstance()->fromFilename($uri)) {
