 ...
 */
abstract class Mediotype_MagentoGuzzle_Model_Event_AbstractTransferEvent extends Mediotype_MagentoGuzzle_Model_Event_AbstractRequestEvent
{
    private $transferInfo;

    /**
     * @param Mediotype_MagentoGuzzle_Model_Adapter_TransactionInterface $transaction  Transaction
     ...
     * Get the response
     *
     * @return Mediotype_MagentoGuzzle_Model_Message_RequestInterface|null
     */
