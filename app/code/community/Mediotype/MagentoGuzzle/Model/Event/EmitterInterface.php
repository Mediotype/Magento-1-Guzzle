 ...
 */
interface Mediotype_MagentoGuzzle_Model_Event_EmitterInterface
{
    /**
     ...
     * @param Mediotype_MagentoGuzzle_Model_Event_EventInterface $event     The event to pass to the event handlers/listeners.
     *
     * @return Mediotype_MagentoGuzzle_Model_Event_EventInterface Returns the provided event object
     */
    public function emit($eventName, Mediotype_MagentoGuzzle_Model_Event_EventInterface $event);
     ...
     *
     * @param Mediotype_MagentoGuzzle_Model_Event_SubscriberInterface $subscriber Subscriber to attach.
     */
    public function attach(Mediotype_MagentoGuzzle_Model_Event_SubscriberInterface $subscriber);

    /**
     * Detaches an event subscriber.
     *
     * @param Mediotype_MagentoGuzzle_Model_Event_SubscriberInterface $subscriber Subscriber to detach.
     */
    public function detach(Mediotype_MagentoGuzzle_Model_Event_SubscriberInterface $subscriber);
}
