 ...
 */
class Mediotype_MagentoGuzzle_Model_Event_Emitter implements Mediotype_MagentoGuzzle_Model_Event_EmitterInterface
{
    /** @var array */
    ...
    public function once($eventName, callable $listener, $priority = 0)
    {
        $onceListener = function (
            Mediotype_MagentoGuzzle_Model_Event_EventInterface $event,
            $eventName
    ...
    {
        return $this->helper->deprecation_proxy($this,
            $name,
            $arguments,
            array(
